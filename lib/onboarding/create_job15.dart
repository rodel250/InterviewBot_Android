  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          context.flow<OnBoardingStages15>().update((next) => OnBoardingStages15.stage2);
        },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          child: Icon(Icons.navigate_next),
          onPressed: (){
            context.flow<OnBoardingStages15>().update((next) => OnBoardingStages15.stage3);
          },
          backgroundColor: Color(0xFF8C383E),
        ),
      appBar: AppBar(
        leading: BackButton(
          onPressed: (){
            context.flow<OnBoardingStages15>().update((previus) => OnBoardingStages15.stage1);
          },
        ),
        title: Text("Create Job"),
        backgroundColor: Color(0xFF8C383E),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: BackButton(
          onPressed: (){
            context.flow<OnBoardingStages15>().update((previus) => OnBoardingStages15.stage2);
          },
        ),
        title: Text("Create Job"),
        backgroundColor: Color(0xFF8C383E),
